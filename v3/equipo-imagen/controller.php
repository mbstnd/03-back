...
class Controlador{
    ...
    public function getAll(){
        $con = new Conexion();
        $sql = "SELECT id, equipo_id, imagen_id FROM equipo_imagen";
    ...
    public function postNuevo($_nuevoObjeto){
        ...
        $sql = "INSERT INTO equipo_imagen (id, equipo_id, imagen_id) VALUES ($id,'$_nuevoObjeto->equipo_id','$_nuevoObjeto->imagen_id',true)";
        // echo $sql;
        // ejecucion SQL
        $rs = [];
        try {
